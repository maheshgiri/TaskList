...
public class ScreenUtils {
    ...
    public static double screenSizeinInch = 0;


    public static int getScreenWidthPixel(Context context) {
        Point p = ScreenUtils.getScreenDimensionsInDIP(context);
        return ScreenUtils.convertDIPToPixels(context, p.x);
    }


    public static int colWidthPixel(int colwidthper, Context context) {
        Point p = ScreenUtils.getScreenDimensionsInDIP(context);
        int screenwidthinpixel = ScreenUtils.convertDIPToPixels(context, p.x) - ScreenUtils.convertDIPToPixels(context, 5);
        return (int) ((float) screenwidthinpixel * colwidthper / 100.0);
    }

    public static int colWidthPixelRelative(int colwidthper, int relativeScreenWidth, Context context) {
        Point p = ScreenUtils.getScreenDimensionsInDIP(context);
        int screenwidthinpixel = ScreenUtils.convertDIPToPixels(context, p.x)  - ScreenUtils.convertDIPToPixels(context, 5);
        return (int) ((float) screenwidthinpixel * relativeScreenWidth / 100.0  * colwidthper / 100.0);
    }

    public static int colHeightPixel(int colheightper, Context context) {
        Point p = ScreenUtils.getScreenDimensionsInDIP(context);
        int screenwidthinpixel = ScreenUtils.convertDIPToPixels(context, p.y) - ScreenUtils.convertDIPToPixels(context, 5);
        return (int) ((float) screenwidthinpixel * colheightper / 100.0);
    }
